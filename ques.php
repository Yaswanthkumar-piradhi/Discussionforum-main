...
<hr>
          <h3 style="text-align:center;">Your questions</h3>

          
          
        <?php
          $sqlrows="select Subject,Question,id from ques where id='$id'";
          $rowc=mysqli_query($con,$sqlrows);
          $rowcount=mysqli_num_rows($rowc);
          
          // $vieww="create view quess as select row_number() OVER(ORDER BY qid ASC) AS RowNo,qid,Subject,Question,id from ques where id='$id'";
          // mysqli_query($con,$vieww);

          // for ($x = 1; $x <= $rowcount; $x++) {
          //   $sqlro="select RowNo,Subject,Question,id from quess where RowNo='$x'";
          ...
          $ar=(mysqli_query($con,"select * from ques where id='$id' order by date DESC"));
          ...
          <div class="container py-5">
            <div class="row align-items-center">
              <div class="col-lg-12">
                ...
                <h3 style="display: inline-block;"><b><?php echo $arr['Subject']; ?></b></h3>
