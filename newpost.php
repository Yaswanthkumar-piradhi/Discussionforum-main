...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Check input errors before inserting in database
        ...
        $sql111 = "INSERT INTO ques (qid,Subject,Question,id) VALUES ('$rowcount',?, ?, ?)";
...
<html>
    ...
    <div class="position-absolute top-50 start-50 translate-middle">
        ...
        <input style="min-width:350px" type="text" class="form-control" name="Subject" placeholder="Example: M1" aria-label="Username" aria-describedby="basic-addon1">
        </div>
